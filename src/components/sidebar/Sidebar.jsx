...
const Sidebar = () => {
    ...
    const { lists, colors, activeList, status } = useSelector(state => state.task_data)
    ...
    return (
        <>
            {status !== 'succeeded' ?
                <div
                    className='loader-wrapper w-1/3 bg-zinc-300 h-full px-6 pt-10 pb-4 flex items-center justify-center'>
